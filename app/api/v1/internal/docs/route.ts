...
<html lang="en">
  <head>
    ...
    <title>AXPO Internal API Docs</title>
  ...
  <body>
    <div class="topbar">
      <div class="topbar-inner">
        <strong>Internal API Documentation</strong> - AXPO RBAC Endpoints
        | <a href="/api/v1/docs">Public API Docs</a>
