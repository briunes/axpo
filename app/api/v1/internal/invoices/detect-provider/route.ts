...
import { buildProviderDetectionPrompt } from "@/application/invoices/providerDetectionPrompt";
...
export const POST = withErrorHandler(async (req: NextRequest) => {
  ...
  const detectionPrompt = buildProviderDetectionPrompt(providerListText);
