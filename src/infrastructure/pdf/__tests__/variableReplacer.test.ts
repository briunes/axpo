  ...
  it("creates a selected-product energy term table from the chosen offer data", () => {
    const electricityVariables = extractVariableValues(
      { id: "simulation-id" },
      {
        ...
        selectedOffer: { productKey: "FIJO:TEST", commodity: "ELECTRICITY" },
      },
      undefined,
      undefined,
      undefined,
    ...
    const gasVariables = extractVariableValues(
      { id: "simulation-id" },
      {
        ...
        selectedOffer: { productKey: "GAS:FIJO", commodity: "GAS" },
      },
      undefined,
      undefined,
      undefined,
    ...
    const spanish = extractVariableValues(
      { id: "simulation-id" },
      {
        ...
        electricity: {
          ...
          personalizadaFijo: {
            preciosEnergia: { P1: 0.02284 },
          },
          consumo: { P1: 100 },
          potenciaContratada: { P1: 1 },
        },
        results: {
          electricity: [
            {
  ...
  it("does not fabricate a repeated average fallback when the exact selected-product row is unavailable", () => {
    const variables = extractVariableValues(
      { id: "simulation-id" },
      {
        ...
        selectedOffer: { productKey: "ESTABLE:N1", commodity: "ELECTRICITY" },
      },
      undefined,
      undefined,
      undefined,
