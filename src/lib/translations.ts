...
export const translations = {
  en: {
    ...
    requestAccess: {
      ...
      subtitle:
        "Send an access request for review by the selected AXPO account manager.",
      fullName: "Full name",
      email: "Business email",
      phone: "Phone number",
      agency: "Agency",
      agencyPlaceholder: "Select your agency",
      kam: "AXPO account manager (KAM)",
      kamPlaceholder: "Select your account manager",
      kamSelectAgency: "Select an agency first",
      comments: "Additional information",
      commentsPlaceholder:
        "Add any information that may help us review your request",
      reviewNotice:
        "Submitting this form requests access; it does not create an account automatically.",
      submit: "Submit request",
      submitting: "Submitting request…",
      submitFailed: "We could not submit your request. Please try again.",
      successTitle: "Request received",
      successMessage:
        "Your request is pending review. The selected AXPO account manager has been notified.",
      backToLogin: "Back to login",
      optionsFailed:
        "We could not load agencies and account managers. Please try again.",
    },
    accessRequests: {
      title: "Access requests",
      subtitle: "Review and manage requests for simulator access.",
      openPage: "Access requests",
      applicant: "Applicant",
      requestedAt: "Requested",
      searchPlaceholder: "Search by name, email, phone or agency…",
      ...
      approveConfirm: "Approve {name} and create a commercial user account?",
      rejectConfirm: "Reject the access request from {name}?",
      approvedSuccess: "Request approved and user created.",
      rejectedSuccess: "Request rejected.",
      loadError: "Could not load access requests.",
      actionError: "Could not update the access request.",
      comments: "Comments",
      kamEmailStatus: "KAM notification",
      applicantEmailStatus: "Applicant confirmation",
      sent: "Sent",
      notSent: "Not sent",
      reviewedAt: "Reviewed",
      assignment: "Agency / KAM",
      review: "Review",
      contact: "Contact",
      emailDelivery: "Email delivery",
      viewPending: "Pending requests",
      viewAll: "All requests",
      viewApproved: "Approved requests",
      viewRejected: "Rejected requests",
    },
    forgotPassword: {
    ...
    actions: {
      ...
      newBaseValueSet: "New base value set",
    ...
    search: {
      ...
      allStatuses: "All statuses",
      globalPlaceholder: "Search simulations, clients, users, agencies...",
      globalMinChars: "Type at least {min} characters to search records.",
      globalSearching: "Searching...",
      globalEmpty: "No records found.",
      globalEmptyRecents: "Recently opened records and pages will appear here.",
      kindSimulation: "Simulation",
      kindUser: "User",
      kindAgency: "Agency",
      kindAgencyTlv: "TLV agency",
      kindClient: "Client",
      kindRecent: "Recent",
    },
    pagination: {
    ...
    simulationsModule: {
      ...
      cupsValidationFailed: "CUPS validation failed.",
      invalidExpirationDays: "Expiration days must be a positive number.",
      createdAsDraft: "Simulation created as draft.",
      invalidPayloadJson: "Payload JSON is invalid — check your edits.",
      updated: "Simulation updated.",
      sharedWithToken: "Shared. Token: {token}",
      shared: "Simulation shared.",
      cloned: "Simulation cloned.",
      pinRefreshed: "PIN snapshot refreshed.",
      ocrPrefillCreated: "OCR prefill version created.",
      pdfDownloaded: "PDF downloaded.",
      archived: "Simulation archived.",
      bulkDeletedResult: "Deleted {succeeded} of {total} simulation(s).",
      bulkArchivedResult: "Archived {succeeded} of {total} simulation(s).",
      calculationCompleted:
        "Calculation completed — {count} products evaluated.",
      ...
      savedViewsGroup: "Saved views",
      deleteSavedView: "Delete saved view",
      presetRecent: "Recent",
      presetMyDrafts: "My Drafts",
      presetSharedWithMe: "Shared With Me",
      presetExpiringSoon: "Expiring Soon",
      presetArchived: "Archived",
      ...
      saveViewDescription:
        "Save the current preset configuration, advanced filters, sorting and archived mode.",
      viewName: "View name",
      cancel: "Cancel",
      save: "Save",
    },
    usersModule: {
      ...
      createdWithPin: "User created. Temporary PIN: {pin}",
      updated: "User updated.",
      userAndPasswordUpdated: "User and password updated.",
      profileRequiredFields: "Full name and email are required.",
      profileUpdated: "Profile updated.",
      statusUpdated: "User status updated.",
      pinRotated: "PIN rotated: {pin}",
      deleted: "User deleted.",
      bulkDeleted: "{count} user(s) deleted.",
    ...
    agenciesModule: {
      ...
      activated: "Agency activated.",
      deactivated: "Agency deactivated.",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreating: "Agencies creating simulations",
      kpiAgenciesCreatingSub: "Their users created simulations in this period",
      ...
      kpiSharedBreakdown: "{email} by email · {pdf} by PDF",
      sharePercentOfShared: "of shares",
      funnelPercentOfCreated: "of created",
      funnelPercentOfEmailed: "of emailed",
      funnelOpenedWeb: "Opened on web",
      kpiSimsShared: "Simulations shared",
      kpiShareMethods: "Sharing methods",
      kpiShareMethodsSub: "{pdf}% PDF · {email}% email",
      kpiUsersCreating: "Simulation creators",
      kpiUsersCreatingSub: "Created simulations in this period",
      kpiEmailSentSub: "{opened} of {sent} emails opened",
      kpiOpenRate: "Open Rate",
      kpiOpenRateSub: "{count} total opens",
      kpiTotalOpens: "Total Opens",
      kpiTotalOpensSub: "Across {count} opened emails",
      ...
      vsPreviousPeriod: "vs previous {days} days",
      previousPeriodValue: "Previous period",
    ...
    baseValuesModule: {
      ...
      activated: "Base value set activated.",
      archived: "Base value set archived.",
      restored: "Base value set restored.",
      bulkArchived: "{count} base value set(s) archived.",
      productionSet:
        "Base value set set as {scope} production. Other {scope} sets marked as draft.",
      newSet: "New base value set",
      editSet_tooltip: "Edit base value set",
      download_tooltip: "Download source Excel file",
      downloadExcel: "Download Excel",
      downloadOriginalExcel: "Download original Excel",
      downloadFilledSimulationExcel: "Download filled with simulation (Beta)",
    ...
    whatsNewModal: {
      ...
      emptyVersion: "No release notes have been published for this version.",
    ...
    simulationDetail: {
      ...
      openInvoiceFailed: "Failed to open invoice",
      loading: "Loading simulation…",
      notFound: "Simulation not found.",
      metaStatus: "Status",
      metaReference: "Ref.",
      metaClient: "Client",
      metaClonedFrom: "Duplicated from",
      metaCups: "CUPS",
      metaExpires: "Expires",
      metaCreated: "Created",
      invoiceFile: "Invoice",
    ...
    simulationIssues: {
      ...
      title: "Report issue",
      snapshotNotice:
        "An immutable Excel copy containing the simulation's current data will be attached automatically.",
      description: "Issue description",
      descriptionRequired: "Describe the problem before submitting the issue.",
      attachFiles: "Attach files",
      maxFileSize: "Maximum size per file: {size} MB",
      remove: "Remove",
      cancel: "Cancel",
      submit: "Submit issue",
      submitting: "Submitting…",
      submitSuccess: "Issue submitted successfully",
      submitError: "The issue could not be submitted.",
      inbox: "Issue inbox",
      status: "Status",
      all: "All",
      statusNew: "New",
      statusInReview: "Ongoing",
      statusEscalated: "Escalated to App administrators",
      emailCreated: "New incident",
      notificationEscalatedTitle: "Incident escalated to system administrators",
      emailEscalated: "Incident escalated",
      emailStatus: "Incident status changed",
      emailResolved: "Incident finalized",
      emailSettings: "Incident emails",
      emailSettingsHelp: "Choose templates for each incident event. No template selected disables that email; in-app notifications remain enabled. Edit templates under Email Templates.",
      incidentNumber: "Incident number",
      exportIncidents: "Export incidents",
      importIncidents: "Import incidents",
      transferHelp: "Exports include the selected rows (up to 100 incidents / 100 MB). Imports preserve files and history, skip existing incidents, and send no notifications.",
      importSummary: "{count} incidents to import; {skipped} already exist and will be skipped.",
      importComplete: "Imported {imported} incidents; skipped {skipped} existing incidents.",
      missingImportUsers: "These users are missing. Required user links will use the importing sys admin; original identities are kept in the history.",
      missingImportSimulations: "These simulations are missing. Incidents will retain their reference and snapshot without a simulation link.",
      appAdministrators: "App administrators",
      appStatus: "App administrator status",
      escalationNotesRequired: "Escalation reason (required)",
      escalationNotesHelp: "Describe why this issue needs technical support. System administrators will be notified.",
      statusResolved: "Resolved",
      statusDismissed: "Dismissed",
      reporterSearch: "Reporter name or email",
      from: "From",
      to: "To",
      loadError: "Issues could not be loaded",
      empty: "No issues match these filters.",
      deletedSimulation: "Deleted simulation",
      simulationExcel: "Simulation Excel",
      changeStatus: "Change status",
      lastChangedBy: "Last changed by {name}",
      backToIssues: "Back to issues",
      issueDetails: "Issue details",
      openSimulation: "Open simulation",
      files: "Files",
      resolution: "Resolution",
      savedResolution: "Saved resolution notes",
      resolutionNotesRequired: "Resolution notes",
      resolutionNotesHelp: "Describe what the issue was and how it was resolved.",
      statusNotes: "Status change notes (optional)",
      saveChanges: "Save changes",
      updateSuccess: "Issue updated successfully",
      history: "Status history",
      noHistory: "No status changes yet.",
      noteAdded: "Note added",
      savedStatusNotes: "Saved status notes",
    ...
    newSimulationPage: {
      ...
      stepCreate: "Create",
      stepChoose: "Choose",
      stepInvoiceUploaded: "Invoice uploaded",
      stepDone: "Done",
      stepReady: "Ready",
      stepWaiting: "Waiting",
    ...
    agencyTlvProducts: {
      title: "Products",
      description:
        "Configure which active products this agency is allowed to offer.",
      loading: "Loading product configuration...",
      loadError: "Failed to load product configuration",
      saveError: "Failed to save product configuration",
      saveSuccess: "Product configuration saved.",
      electricity: "Electricity",
      gas: "Gas",
      fixed: "Fixed",
      indexed: "Indexed",
    ...
    systemSettings: {
      ...
      fieldAppVersionDesc:
        "Set the new version before deployment. Saving it publishes the version and refreshes all clients.",
      fieldAppChangelogNotes: "Release notes",
      fieldAppChangelogNotesDesc:
        "Saved to the version history when the app version changes. Use one line per change.",
      fieldAppChangelogNotesPublishDesc:
        "Add the release notes before publishing the version above. Both will be saved together.",
      appChangelogNotesRequired:
        "Add release notes before publishing a new app version.",
      fieldAppChangelogNotesPlaceholder:
        "Improved dashboard filters\nAdded invoice upload validation\nFixed PDF export totals",
      appChangelogHistory: "Version history",
      appChangelogEmpty: "No version history has been recorded yet.",
      ...
      fieldSimulationIssuesEnabled: "Simulation incidents",
      incidentSettingsDescription: "Reporting, notification recipients, and menu access.",
      incidentRecipients: "Notification recipients",
      incidentAdmins: "Admins",
      incidentSysAdmins: "Sys Admins",
      incidentAddRecipient: "Add a recipient",
      incidentNoAvailableUsers: "No matching users available",
      incidentNoSelectedUsers: "No recipients selected.",
      incidentRecipientsHelp: "Selected Admins receive incident notifications. Selected Sys Admins receive escalations. Only selected users can access Simulation Issues. Reporters still receive updates on their own incidents.",
      incidentRecipientsEmpty: "No administrators are selected. The Simulation Issues menu will be hidden for everyone.",
      incidentSettingsSaved: "Incident settings saved.",
      incidentSettingsError: "Unable to load or save incident settings. Please try again.",
      fieldSimulationIssuesEnabledDesc:
        "Allow users to report incidents from simulations.",
      fieldElectricityPersonalizedFixedEnabled:
        "Electricity personalized fixed offer",
      fieldElectricityPersonalizedFixedEnabledDesc:
        "Show the Personalized Fixed inputs and offer in electricity simulations.",
      fieldAccessRequestsEnabled: "Access requests",
      fieldAccessRequestsEnabledDesc:
        "Allow prospective users to submit access requests from the login page.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmails: "Access Request Emails",
      titleAccessRequestEmailsDesc:
        "Choose the templates sent to the selected KAM and applicant when a request is submitted.",
      fieldAccessRequestKamTemplate: "KAM Notification Template",
      fieldAccessRequestKamTemplateDesc:
        "Template sent to the selected KAM for review.",
      fieldAccessRequestApplicantTemplate: "Applicant Confirmation Template",
      fieldAccessRequestApplicantTemplateDesc:
        "Template confirming that the request is pending review.",
    ...
    invoiceExtractor: {
      ...
      flowDescription:
        "Upload an invoice, confirm the provider, extract the fields, then validate before creating the simulation.",
    ...
    emailTemplatesModule: {
      ...
      typeAccessRequestKam: "Access Request · KAM",
      typeAccessRequestApplicant: "Access Request · Applicant",
    ...
    rolePermissionsModule: {
      ...
      perm_label_section_simulation_issues: "Simulation Issues",
      ...
      perm_label_simulations_download_excel: "Download simulation Excel",
      ...
      perm_desc_section_simulation_issues:
        "Review simulation issues reported by agents (admin only)",
      ...
      perm_desc_simulations_download_excel:
  ...
  es: {
    ...
    login: {
      ...
      requestAccess: "Solicitar alta",
    },
    requestAccess: {
      title: "Solicitar alta",
      subtitle:
        "Envía una solicitud de acceso para que la revise el KAM de AXPO seleccionado.",
      fullName: "Nombre y apellidos",
      email: "Correo electrónico profesional",
      phone: "Teléfono",
      agency: "Agencia",
      agencyPlaceholder: "Selecciona tu agencia",
      kam: "KAM de AXPO",
      kamPlaceholder: "Selecciona tu KAM",
      kamSelectAgency: "Selecciona primero una agencia",
      comments: "Información adicional",
      commentsPlaceholder:
        "Añade cualquier información que nos ayude a revisar tu solicitud",
      reviewNotice:
        "El envío de este formulario solicita el acceso; no crea una cuenta automáticamente.",
      submit: "Enviar solicitud",
      submitting: "Enviando solicitud…",
      submitFailed: "No se pudo enviar la solicitud. Inténtalo de nuevo.",
      successTitle: "Solicitud recibida",
      successMessage:
        "Tu solicitud está pendiente de revisión. Se ha notificado al KAM de AXPO seleccionado.",
      backToLogin: "Volver al inicio de sesión",
      optionsFailed:
        "No se pudieron cargar las agencias y los KAM. Inténtalo de nuevo.",
    },
    accessRequests: {
      title: "Solicitudes de alta",
      subtitle: "Revisa y gestiona las solicitudes de acceso al simulador.",
      openPage: "Solicitudes de alta",
      applicant: "Solicitante",
      requestedAt: "Solicitada",
      searchPlaceholder: "Buscar por nombre, correo, teléfono o agencia…",
      allStatuses: "Todos los estados",
      pending: "Pendiente",
      approved: "Aprobada",
      rejected: "Rechazada",
      empty: "No hay solicitudes de alta.",
      approve: "Aprobar",
      reject: "Rechazar",
      approveTitle: "Aprobar solicitud",
      rejectTitle: "Rechazar solicitud",
      approveConfirm:
        "¿Aprobar a {name} y crear una cuenta de usuario comercial?",
      rejectConfirm: "¿Rechazar la solicitud de {name}?",
      approvedSuccess: "Solicitud aprobada y usuario creado.",
      ...
      kamEmailStatus: "Notificación al KAM",
      applicantEmailStatus: "Confirmación al solicitante",
      sent: "Enviado",
      notSent: "No enviado",
      reviewedAt: "Revisada",
      assignment: "Agencia / KAM",
      review: "Revisión",
      contact: "Contacto",
      emailDelivery: "Envío de correos",
      viewPending: "Solicitudes pendientes",
      viewAll: "Todas las solicitudes",
      viewApproved: "Solicitudes aprobadas",
      viewRejected: "Solicitudes rechazadas",
    },
    forgotPassword: {
    ...
    actions: {
      ...
      newBaseValueSet: "Nuevo conjunto de valores base",
      viewSystemLogs: "Ver registros del sistema",
    ...
    search: {
      ...
      allStatuses: "Todos los estados",
      globalPlaceholder: "Buscar simulaciones, clientes, usuarios, agencias...",
      globalMinChars:
        "Escribe al menos {min} caracteres para buscar registros.",
      globalSearching: "Buscando...",
      globalEmpty: "No se encontraron registros.",
      globalEmptyRecents:
        "Los registros y páginas abiertos recientemente aparecerán aquí.",
      kindSimulation: "Simulación",
      kindUser: "Usuario",
      kindAgency: "Agencia",
      kindAgencyTlv: "Agencia TLV",
      kindClient: "Cliente",
      kindRecent: "Reciente",
    },
    pagination: {
    ...
    simulationsModule: {
      ...
      cupsValidationFailed: "La validación de CUPS ha fallado.",
      invalidExpirationDays:
        "Los días de caducidad deben ser un número positivo.",
      createdAsDraft: "Simulación creada como borrador.",
      invalidPayloadJson: "El JSON de datos no es válido; revisa los cambios.",
      updated: "Simulación actualizada.",
      sharedWithToken: "Compartida. Token: {token}",
      shared: "Simulación compartida.",
      cloned: "Simulación clonada.",
      pinRefreshed: "Instantánea del PIN actualizada.",
      ocrPrefillCreated: "Versión de precarga OCR creada.",
      pdfDownloaded: "PDF descargado.",
      archived: "Simulación archivada.",
      bulkDeletedResult: "Eliminadas {succeeded} de {total} simulaciones.",
      bulkArchivedResult: "Archivadas {succeeded} de {total} simulaciones.",
      calculationCompleted: "Cálculo completado — {count} productos evaluados.",
      ...
      statusShared: "Compartida",
      clientViewed: "Visto",
      sharedViaEmail: "Por Email",
      sharedViaPdf: "Por PDF",
      viewPresetLabel: "Vista",
      customView: "Vista personalizada",
      savedViewsGroup: "Vistas guardadas",
      deleteSavedView: "Eliminar vista guardada",
      presetRecent: "Recientes",
      presetMyDrafts: "Mis borradores",
      presetSharedWithMe: "Compartidas conmigo",
      presetExpiringSoon: "Próximas a expirar",
      presetArchived: "Archivadas",
      filtersTitle: "Filtros",
      saveView: "Guardar vista",
      ownerFilter: "Propietario",
      clientFilter: "Cliente",
      statusFilter: "Estado",
      typeFilter: "Tipo",
      allTypes: "Todos los tipos",
      typeElectricity: "Electricidad",
      typeGas: "Gas",
      typeBoth: "Ambos",
      cupsFilter: "CUPS",
      createdFrom: "Creada desde",
      createdTo: "Creada hasta",
      expiresFrom: "Expira desde",
      expiresTo: "Expira hasta",
      sortBy: "Ordenar por",
      sortDirection: "Dirección",
      sortUpdated: "Actualizada",
      sortCreated: "Creada",
      sortExpires: "Expira",
      sortReference: "Referencia",
      sortStatus: "Estado",
      directionDescending: "Descendente",
      directionAscending: "Ascendente",
      clearFilters: "Limpiar filtros",
      applyFilters: "Aplicar filtros",
      saveViewTitle: "Guardar vista",
      saveViewDescription:
        "Guarda la configuración actual de vista, filtros avanzados, orden y modo de archivadas.",
    ...
    usersModule: {
      ...
      createRequiredFields:
        "El nombre, correo, teléfono móvil, contacto comercial y agencia son obligatorios.",
      updateRequiredFields:
        "El nombre completo, correo, teléfono móvil y contactos comerciales son obligatorios.",
      passwordPolicy:
        "La contraseña debe tener entre 12 y 128 caracteres e incluir mayúsculas, minúsculas, un número y un carácter especial.",
      newPasswordPolicy:
        "La nueva contraseña debe cumplir la política de seguridad.",
      agentCreateRestriction:
        "El agente solo puede crear usuarios comerciales en su misma agencia.",
      currentPasswordRequired:
        "La contraseña actual es obligatoria para cambiar tu propia contraseña.",
      created: "Usuario creado.",
      createdWithPin: "Usuario creado. PIN temporal: {pin}",
      updated: "Usuario actualizado.",
      userAndPasswordUpdated: "Usuario y contraseña actualizados.",
      profileRequiredFields: "El nombre completo y el correo son obligatorios.",
      profileUpdated: "Perfil actualizado.",
      statusUpdated: "Estado del usuario actualizado.",
      pinRotated: "PIN renovado: {pin}",
      deleted: "Usuario eliminado.",
      bulkDeleted: "{count} usuario(s) eliminado(s).",
      passwordResetSent: "Correo de restablecimiento enviado a {email}",
    ...
    agenciesModule: {
      ...
      nameRequired: "El nombre de la agencia es obligatorio.",
      created: "Agencia creada.",
      updated: "Agencia actualizada.",
      activated: "Agencia activada.",
      deactivated: "Agencia desactivada.",
    ...
    logs: {
      ...
      simulationIssues: "Incidencias de simulaciones",
      timestamp: "Marca de Tiempo",
      type: "Tipo",
      status: "Estado",
      message: "Mensaje",
      ...
      unexpectedErrors: "Errores inesperados",
      ...
      openCount: "{count} aperturas",
      lastOpenedAt: "Última apertura",
      error: "Error",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreating: "Agencias creadoras",
      kpiAgenciesCreatingSub:
        "Sus usuarios crearon simulaciones en este período",
      ...
      kpiSharedBreakdown: "{email} por email · {pdf} por PDF",
      sharePercentOfShared: "de compartidas",
      funnelPercentOfCreated: "de creadas",
      funnelPercentOfEmailed: "de enviadas por email",
      funnelOpenedWeb: "Abiertas en web",
      kpiSimsShared: "Simulaciones compartidas",
      kpiShareMethods: "Métodos de envío",
      kpiShareMethodsSub: "{pdf}% PDF · {email}% email",
      kpiUsersCreating: "Usuarios creadores",
      kpiUsersCreatingSub: "Crearon simulaciones en este período",
      kpiEmailSentSub: "{opened} de {sent} emails abiertos",
      kpiOpenRate: "Tasa de Apertura Web",
      kpiOpenRateSub: "{count} aperturas totales",
      kpiTotalOpens: "Total de Aperturas",
      kpiTotalOpensSub: "En {count} emails abiertos",
      ...
      vsPreviousPeriod: "vs. los {days} días anteriores",
      previousPeriodValue: "Período anterior",
    ...
    baseValuesModule: {
      ...
      activated: "Conjunto de valores base activado.",
      archived: "Conjunto de valores base archivado.",
      restored: "Conjunto de valores base restaurado.",
      bulkArchived: "{count} conjunto(s) de valores base archivado(s).",
      productionSet:
        "Conjunto establecido como producción {scope}. Los demás conjuntos {scope} se marcaron como borrador.",
      ...
      downloadOriginalExcel: "Descargar Excel original",
      downloadFilledSimulationExcel:
        "Descargar Excel con datos de la simulación (Beta)",
    ...
    whatsNewModal: {
      ...
      empty: "Aún no se han publicado notas de la versión.",
      emptyVersion: "No se han publicado notas para esta versión.",
      goToChangelog: "Ir al registro de cambios",
    },
    auth: {
    ...
    simulationDetail: {
      ...
      shareLinkCopyFailed: "No se pudo copiar el enlace",
      openInvoiceFailed: "No se pudo abrir la factura",
      loading: "Cargando simulación…",
      notFound: "Simulación no encontrada.",
      metaStatus: "Estado",
      metaReference: "Ref.",
      metaClient: "Cliente",
      metaClonedFrom: "Duplicada desde",
      metaCups: "CUPS",
      metaExpires: "Expira",
      metaCreated: "Creado",
      invoiceFile: "Factura",
    ...
    simulationIssues: {
      ...
      snapshotNotice:
        "Se adjuntará automáticamente una copia inalterable del Excel con los datos actuales de la simulación.",
      description: "Descripción del problema",
      descriptionRequired:
        "Describe el problema antes de enviar la incidencia.",
      ...
      submitting: "Enviando…",
      submitSuccess: "Incidencia enviada correctamente",
      submitError: "No se pudo enviar la incidencia.",
      inbox: "Buzón de incidencias",
      status: "Estado",
      all: "Todos",
      statusNew: "Nueva",
      statusInReview: "En curso",
      statusEscalated: "Escalada a administradores de la aplicación",
      emailCreated: "Nueva incidencia",
      notificationEscalatedTitle: "Incidencia escalada a los administradores del sistema",
      emailEscalated: "Incidencia escalada",
      emailStatus: "Cambio de estado de incidencia",
      emailResolved: "Incidencia finalizada",
      emailSettings: "Correos de incidencias",
      emailSettingsHelp: "Elige una plantilla por evento. Sin plantilla se desactiva ese correo; las notificaciones en la aplicación siguen activas. Edita las plantillas en Plantillas de correo.",
      incidentNumber: "Número de incidencia",
      exportIncidents: "Exportar incidencias",
      importIncidents: "Importar incidencias",
      transferHelp: "La exportación incluye las filas seleccionadas (hasta 100 incidencias / 100 MB). La importación conserva archivos e historial, omite incidencias existentes y no envía notificaciones.",
      importSummary: "{count} incidencias para importar; {skipped} ya existen y se omitirán.",
      importComplete: "{imported} incidencias importadas; {skipped} existentes omitidas.",
      missingImportUsers: "Faltan estos usuarios. Los vínculos obligatorios usarán al sys admin que importa; las identidades originales se conservarán en el historial.",
      missingImportSimulations: "Faltan estas simulaciones. Las incidencias conservarán su referencia y captura sin vínculo a la simulación.",
      appAdministrators: "Administradores de la aplicación",
      appStatus: "Estado de administradores de la aplicación",
      escalationNotesRequired: "Motivo de escalado (obligatorio)",
      escalationNotesHelp: "Describe por qué esta incidencia necesita soporte técnico. Se notificará a los administradores del sistema.",
      statusResolved: "Resuelta",
      statusDismissed: "Descartada",
      reporterSearch: "Nombre o email del informador",
      from: "Desde",
      to: "Hasta",
      loadError: "No se pudieron cargar las incidencias",
      empty: "No hay incidencias con estos filtros.",
      deletedSimulation: "Simulación eliminada",
      simulationExcel: "Excel de la simulación",
      changeStatus: "Cambiar estado",
      lastChangedBy: "Último cambio por {name}",
      backToIssues: "Volver a incidencias",
      issueDetails: "Detalle de la incidencia",
      openSimulation: "Abrir simulación",
      files: "Archivos",
      resolution: "Resolución",
      savedResolution: "Notas de resolución guardadas",
      resolutionNotesRequired: "Notas de resolución",
      resolutionNotesHelp: "Describe cuál era la incidencia y cómo se resolvió.",
      statusNotes: "Notas del cambio de estado (opcional)",
      saveChanges: "Guardar cambios",
      updateSuccess: "Incidencia actualizada correctamente",
      history: "Historial de estados",
      noHistory: "Todavía no hay cambios de estado.",
      noteAdded: "Nota añadida",
      savedStatusNotes: "Notas de estado guardadas",
      noteCountSingle: "nota",
      noteCountPlural: "notas",
    ...
    newSimulationPage: {
      ...
      stepCreate: "Crear",
      stepChoose: "Elegir",
      stepInvoiceUploaded: "Factura cargada",
      stepDone: "Hecho",
      stepReady: "Listo",
    ...
    agencyTlvProducts: {
      title: "Productos",
      description:
        "Configura qué productos activos puede ofrecer esta agencia.",
      loading: "Cargando configuración de productos...",
      loadError: "Error al cargar la configuración de productos",
      saveError: "Error al guardar la configuración de productos",
      saveSuccess: "Configuración de productos guardada.",
      electricity: "Electricidad",
      gas: "Gas",
      fixed: "Fijo",
      indexed: "Indexado",
    ...
    systemSettings: {
      ...
      fieldAppVersionDesc:
        "Define la nueva versión antes del despliegue. Al guardarla, se publica la versión y se actualizan todos los clientes.",
      fieldAppChangelogNotes: "Notas de la versión",
      fieldAppChangelogNotesDesc:
        "Se guardan en el historial cuando cambia la versión de la aplicación. Usa una línea por cambio.",
      fieldAppChangelogNotesPublishDesc:
        "Añade las notas antes de publicar la versión indicada arriba. Ambas se guardarán juntas.",
      appChangelogNotesRequired:
        "Añade las notas de la versión antes de publicar una nueva versión.",
      fieldAppChangelogNotesPlaceholder:
        "Mejorados los filtros del dashboard\nAñadida validación de facturas\nCorregidos totales de exportación PDF",
      appChangelogHistory: "Historial de versiones",
      appChangelogEmpty: "Todavía no hay historial de versiones.",
      ...
      fieldSimulationIssuesEnabled: "Incidencias de simulaciones",
      incidentSettingsDescription: "Reportes, destinatarios de notificaciones y acceso al menú.",
      incidentRecipients: "Destinatarios de notificaciones",
      incidentAdmins: "Administradores",
      incidentSysAdmins: "Administradores del sistema",
      incidentAddRecipient: "Añadir destinatario",
      incidentNoAvailableUsers: "No hay usuarios disponibles que coincidan",
      incidentNoSelectedUsers: "No hay destinatarios seleccionados.",
      incidentRecipientsHelp: "Los administradores seleccionados reciben notificaciones de incidencias. Los administradores del sistema seleccionados reciben los escalados. Solo los usuarios seleccionados pueden acceder a Incidencias. Los informantes siguen recibiendo actualizaciones de sus propias incidencias.",
      incidentRecipientsEmpty: "No hay administradores seleccionados. El menú de incidencias estará oculto para todos.",
      incidentSettingsSaved: "Configuración de incidencias guardada.",
      incidentSettingsError: "No se pudo cargar o guardar la configuración. Inténtalo de nuevo.",
      fieldSimulationIssuesEnabledDesc:
        "Permite a los usuarios reportar incidencias desde las simulaciones.",
      fieldElectricityPersonalizedFixedEnabled:
        "Oferta fija personalizada de electricidad",
      fieldElectricityPersonalizedFixedEnabledDesc:
        "Muestra los campos y la oferta Personalizada Fixed en las simulaciones de electricidad.",
      fieldAccessRequestsEnabled: "Solicitudes de acceso",
      fieldAccessRequestsEnabledDesc:
        "Permite solicitar acceso desde la página de inicio de sesión.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmails: "Correos de Solicitud de Alta",
      titleAccessRequestEmailsDesc:
        "Selecciona las plantillas enviadas al KAM y al solicitante al recibir una solicitud.",
      fieldAccessRequestKamTemplate: "Plantilla de Notificación al KAM",
      fieldAccessRequestKamTemplateDesc:
        "Plantilla enviada al KAM seleccionado para su revisión.",
      fieldAccessRequestApplicantTemplate:
        "Plantilla de Confirmación al Solicitante",
      fieldAccessRequestApplicantTemplateDesc:
        "Plantilla que confirma que la solicitud está pendiente de revisión.",
    ...
    invoiceExtractor: {
      ...
      flowDescription:
        "Sube una factura, confirma el proveedor, extrae los campos y valida antes de crear la simulación.",
    ...
    emailTemplatesModule: {
      ...
      typeAccessRequestKam: "Solicitud de Alta · KAM",
      typeAccessRequestApplicant: "Solicitud de Alta · Solicitante",
    ...
    rolePermissionsModule: {
      ...
      perm_label_section_simulation_issues: "Incidencias de simulaciones",
      ...
      perm_label_simulations_download_excel: "Descargar Excel de simulación",
      ...
      perm_desc_section_simulation_issues:
        "Revisar incidencias de simulaciones reportadas por agentes (solo admin)",
      ...
      perm_desc_simulations_download_excel:
        "Descargar libros Excel originales o completados con la simulación (solo admin)",
      perm_desc_simulations_delete:
  ...
  fr: {
    ...
    simulationDetail: {
      ...
      shareLinkCopyFailed: "Impossible de copier le lien",
      openInvoiceFailed: "Impossible d’ouvrir la facture",
      loading: "Chargement de la simulation…",
      notFound: "Simulation introuvable.",
      metaStatus: "Statut",
      metaReference: "Réf.",
      metaClient: "Client",
      metaClonedFrom: "Dupliquée depuis",
      metaExpires: "Expire",
      metaCreated: "Créé",
      invoiceFile: "Facture",
    ...
    simulationIssues: {
      ...
      snapshotNotice:
        "Une copie Excel non modifiable contenant les données actuelles de la simulation sera jointe automatiquement.",
      description: "Description du problème",
      descriptionRequired: "Décrivez le problème avant d'envoyer l'incident.",
      attachFiles: "Joindre des fichiers",
      maxFileSize: "Taille maximale par fichier : {size} MB",
      remove: "Retirer",
      cancel: "Annuler",
      submit: "Envoyer l'incident",
      submitting: "Envoi…",
      submitSuccess: "Incident envoyé avec succès",
      submitError: "L'incident n'a pas pu être envoyé.",
      inbox: "Boîte des incidents",
      status: "Statut",
      all: "Tous",
      statusNew: "Nouveau",
      statusInReview: "En cours",
      statusEscalated: "Transmis aux administrateurs de l’application",
      emailCreated: "Nouvel incident",
      notificationEscalatedTitle: "Incident transmis aux administrateurs système",
      emailEscalated: "Incident escaladé",
      emailStatus: "Changement de statut",
      emailResolved: "Incident finalisé",
      emailSettings: "E-mails des incidents",
      emailSettingsHelp: "Choisissez un modèle par événement. Sans modèle, cet e-mail est désactivé ; les notifications restent actives. Modifiez les modèles dans Modèles d’e-mail.",
      incidentNumber: "Numéro d’incident",
      exportIncidents: "Exporter les incidents",
      importIncidents: "Importer les incidents",
      transferHelp: "L’export inclut les lignes sélectionnées (100 incidents / 100 Mo maximum). L’import conserve les fichiers et l’historique, ignore les incidents existants et n’envoie aucune notification.",
      importSummary: "{count} incidents à importer ; {skipped} existent déjà et seront ignorés.",
      importComplete: "{imported} incidents importés ; {skipped} incidents existants ignorés.",
      missingImportUsers: "Ces utilisateurs sont absents. Les liens obligatoires utiliseront l’administrateur qui importe ; les identités d’origine seront conservées dans l’historique.",
      missingImportSimulations: "Ces simulations sont absentes. Les incidents conserveront leur référence et leur capture sans lien vers la simulation.",
      appAdministrators: "Administrateurs de l’application",
      appStatus: "Statut des administrateurs de l’application",
      escalationNotesRequired: "Motif de transmission (obligatoire)",
      escalationNotesHelp: "Décrivez pourquoi cet incident nécessite une assistance technique. Les administrateurs système seront avertis.",
      statusResolved: "Résolu",
      statusDismissed: "Rejeté",
      reporterSearch: "Nom ou e-mail du déclarant",
      from: "Du",
      to: "Au",
      loadError: "Impossible de charger les incidents",
      empty: "Aucun incident ne correspond à ces filtres.",
      deletedSimulation: "Simulation supprimée",
      simulationExcel: "Excel de la simulation",
      changeStatus: "Modifier le statut",
      lastChangedBy: "Dernière modification par {name}",
    },
    simulationView: {
      fieldCups: "CUPS",
    ...
    newSimulationPage: {
      ...
      stepSource: "Source",
      stepExtract: "Extraire",
      stepValidate: "Valider",
      stepCreate: "Créer",
      stepChoose: "Choisir",
      stepInvoiceUploaded: "Facture téléchargée",
      stepDone: "Terminé",
      stepReady: "Prêt",
    ...
    invoiceExtractor: {
      ...
      flowDescription:
        "Téléchargez une facture, confirmez le fournisseur, extrayez les champs, puis validez avant de créer la simulation.",
    ...
    requestAccess: {
      ...
      subtitle:
        "Envoyez une demande d'accès qui sera examinée par le responsable AXPO sélectionné.",
      fullName: "Nom complet",
      email: "E-mail professionnel",
      phone: "Téléphone",
      agency: "Agence",
      agencyPlaceholder: "Sélectionnez votre agence",
      kam: "Responsable AXPO (KAM)",
      kamPlaceholder: "Sélectionnez votre responsable",
      kamSelectAgency: "Sélectionnez d'abord une agence",
      comments: "Informations complémentaires",
      commentsPlaceholder:
        "Ajoutez toute information utile à l'examen de votre demande",
      reviewNotice:
        "L'envoi de ce formulaire demande un accès ; il ne crée pas automatiquement un compte.",
      submit: "Envoyer la demande",
      submitting: "Envoi de la demande…",
      submitFailed: "Impossible d'envoyer votre demande. Veuillez réessayer.",
      successTitle: "Demande reçue",
      successMessage:
        "Votre demande est en attente d'examen. Le responsable AXPO sélectionné a été informé.",
      backToLogin: "Retour à la connexion",
      optionsFailed:
        "Impossible de charger les agences et responsables. Veuillez réessayer.",
    },
    accessRequests: {
      title: "Demandes d’accès",
      subtitle: "Examinez et gérez les demandes d’accès au simulateur.",
      openPage: "Demandes d’accès",
      applicant: "Demandeur",
      requestedAt: "Demandée",
      searchPlaceholder: "Rechercher par nom, e-mail, téléphone ou agence…",
      ...
      approveConfirm: "Approuver {name} et créer un compte commercial ?",
      rejectConfirm: "Rejeter la demande de {name} ?",
      approvedSuccess: "Demande approuvée et utilisateur créé.",
      rejectedSuccess: "Demande rejetée.",
      loadError: "Impossible de charger les demandes.",
      actionError: "Impossible de mettre à jour la demande.",
      comments: "Commentaires",
      kamEmailStatus: "Notification au KAM",
      applicantEmailStatus: "Confirmation au demandeur",
      sent: "Envoyée",
      notSent: "Non envoyée",
      reviewedAt: "Examinée",
      assignment: "Agence / KAM",
      review: "Examen",
      contact: "Contact",
      emailDelivery: "Envoi des e-mails",
      viewPending: "Demandes en attente",
      viewAll: "Toutes les demandes",
      viewApproved: "Demandes approuvées",
      viewRejected: "Demandes rejetées",
    },
    forgotPassword: {
    ...
    actions: {
      ...
      newBaseValueSet: "Nouvel ensemble de valeurs de base",
    ...
    search: {
      ...
      allStatuses: "Tous les statuts",
      globalPlaceholder:
        "Rechercher des simulations, clients, utilisateurs, agences...",
      globalMinChars:
        "Saisissez au moins {min} caractères pour rechercher des enregistrements.",
      globalSearching: "Recherche en cours...",
      globalEmpty: "Aucun enregistrement trouvé.",
      globalEmptyRecents:
        "Les enregistrements et pages ouverts récemment apparaîtront ici.",
      kindSimulation: "Simulation",
      kindUser: "Utilisateur",
      kindAgency: "Agence",
      kindAgencyTlv: "Agence TLV",
      kindClient: "Client",
      kindRecent: "Récent",
    },
    pagination: {
    ...
    simulationsModule: {
      ...
      cupsValidationFailed: "La validation CUPS a échoué.",
      invalidExpirationDays:
        "Le nombre de jours d’expiration doit être positif.",
      createdAsDraft: "Simulation créée comme brouillon.",
      invalidPayloadJson:
        "Le JSON des données est invalide ; vérifiez vos modifications.",
      updated: "Simulation mise à jour.",
      sharedWithToken: "Partagée. Jeton : {token}",
      shared: "Simulation partagée.",
      cloned: "Simulation clonée.",
      pinRefreshed: "Instantané du PIN actualisé.",
      ocrPrefillCreated: "Version de préremplissage OCR créée.",
      pdfDownloaded: "PDF téléchargé.",
      archived: "Simulation archivée.",
      bulkDeletedResult: "{succeeded} simulation(s) supprimée(s) sur {total}.",
      bulkArchivedResult: "{succeeded} simulation(s) archivée(s) sur {total}.",
      calculationCompleted: "Calcul terminé — {count} produits évalués.",
      ...
      statusShared: "Partagée",
      clientViewed: "Consulté",
      sharedViaEmail: "Par e-mail",
      sharedViaPdf: "Via PDF",
      viewPresetLabel: "Vue",
      customView: "Vue personnalisée",
      savedViewsGroup: "Vues enregistrées",
      deleteSavedView: "Supprimer la vue enregistrée",
      presetRecent: "Récentes",
      presetMyDrafts: "Mes brouillons",
      presetSharedWithMe: "Partagées avec moi",
      presetExpiringSoon: "Expire bientôt",
      presetArchived: "Archivées",
      filtersTitle: "Filtres",
      saveView: "Enregistrer la vue",
      ownerFilter: "Propriétaire",
      clientFilter: "Client",
      statusFilter: "Statut",
      typeFilter: "Type",
      allTypes: "Tous les types",
      typeElectricity: "Électricité",
      typeGas: "Gaz",
      typeBoth: "Les deux",
      cupsFilter: "CUPS",
      createdFrom: "Créée depuis",
      createdTo: "Créée jusqu'à",
      expiresFrom: "Expire depuis",
      expiresTo: "Expire jusqu'à",
      sortBy: "Trier par",
      sortDirection: "Direction",
      sortUpdated: "Mise à jour",
      sortCreated: "Créée",
      sortExpires: "Expiration",
      sortReference: "Référence",
      sortStatus: "Statut",
      ...
      saveViewDescription:
        "Enregistre la configuration actuelle de la vue, les filtres avancés, le tri et le mode archivé.",
    ...
    usersModule: {
      ...
      createRequiredFields:
        "Le nom, l’e-mail, le téléphone portable, le contact commercial et l’agence sont obligatoires.",
      updateRequiredFields:
        "Le nom complet, l’e-mail, le téléphone portable et les contacts commerciaux sont obligatoires.",
      passwordPolicy:
        "Le mot de passe doit comporter 12 à 128 caractères avec majuscule, minuscule, chiffre et caractère spécial.",
      newPasswordPolicy:
        "Le nouveau mot de passe doit respecter la politique de sécurité.",
      agentCreateRestriction:
        "L’agent ne peut créer que des utilisateurs commerciaux dans la même agence.",
      currentPasswordRequired:
        "Le mot de passe actuel est requis pour modifier votre propre mot de passe.",
      created: "Utilisateur créé.",
      createdWithPin: "Utilisateur créé. PIN temporaire : {pin}",
      updated: "Utilisateur mis à jour.",
      userAndPasswordUpdated: "Utilisateur et mot de passe mis à jour.",
      profileRequiredFields: "Le nom complet et l’e-mail sont obligatoires.",
      profileUpdated: "Profil mis à jour.",
      statusUpdated: "Statut de l’utilisateur mis à jour.",
      pinRotated: "PIN renouvelé : {pin}",
      deleted: "Utilisateur supprimé.",
      bulkDeleted: "{count} utilisateur(s) supprimé(s).",
      passwordResetSent: "E-mail de réinitialisation envoyé à {email}",
    ...
    agenciesModule: {
      ...
      nameRequired: "Le nom de l’agence est obligatoire.",
    ...
    logs: {
      ...
      simulationIssues: "Incidents de simulation",
      timestamp: "Horodatage",
      type: "Tapez",
      status: "Statut",
      message: "Message",
      ...
      unexpectedErrors: "Erreurs inattendues",
      ...
      openCount: "{count} ouvertures",
      lastOpenedAt: "Dernière ouverture",
      failed: "Échec",
      sent: "Envoyé",
      error: "Erreur",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreating: "Agences créatrices",
      kpiAgenciesCreatingSub:
        "Leurs utilisateurs ont créé des simulations sur cette période",
      ...
      kpiSharedBreakdown: "{email} par e-mail · {pdf} par PDF",
      sharePercentOfShared: "des partages",
      funnelPercentOfCreated: "des créations",
      funnelPercentOfEmailed: "des envois par e-mail",
      funnelOpenedWeb: "Ouvertes sur le web",
      kpiSimsShared: "Simulations partagées",
      kpiShareMethods: "Modes de partage",
      kpiShareMethodsSub: "{pdf}% PDF · {email}% e-mail",
      kpiUsersCreating: "Créateurs de simulations",
      kpiUsersCreatingSub: "Ont créé des simulations sur cette période",
      kpiEmailSentSub: "{opened} e-mails ouverts sur {sent}",
      kpiOpenRate: "Taux d'ouverture",
      kpiOpenRateSub: "{count} ouvertures totales",
      kpiTotalOpens: "Nombre total d'ouvertures",
      kpiTotalOpensSub: "Sur {count} e-mails ouverts",
      ...
      vsPreviousPeriod: "vs les {days} jours précédents",
      previousPeriodValue: "Période précédente",
    ...
    baseValuesModule: {
      ...
      activated: "Ensemble de valeurs de base activé.",
      archived: "Ensemble de valeurs de base archivé.",
      restored: "Ensemble de valeurs de base restauré.",
      bulkArchived: "{count} ensemble(s) de valeurs de base archivé(s).",
      productionSet:
        "Ensemble défini comme production {scope}. Les autres ensembles {scope} ont été marqués comme brouillons.",
      ...
      downloadOriginalExcel: "Télécharger le fichier Excel original",
      downloadFilledSimulationExcel:
        "Télécharger Excel avec les données de la simulation (Beta)",
    ...
    whatsNewModal: {
      ...
      empty: "Aucune note de version n'a encore été publiée.",
      emptyVersion:
        "Aucune note de version n'a été publiée pour cette version.",
      goToChangelog: "Accéder au journal des modifications",
    },
    auth: {
      login: "Connexion",
      logout: "Déconnexion",
    ...
    agencyTlvProducts: {
      title: "Produits",
      description:
        "Configurez les produits actifs que cette agence est autorisée à proposer.",
      loading: "Chargement de la configuration des produits...",
      loadError: "Échec du chargement de la configuration des produits",
      saveError: "Échec de l'enregistrement de la configuration des produits",
      saveSuccess: "Configuration des produits enregistrée.",
      electricity: "Électricité",
      gas: "Gaz",
      fixed: "Corrigé",
      indexed: "Indexé",
    ...
    systemSettings: {
      ...
      fieldAppVersionDesc:
        "Définissez la nouvelle version avant le déploiement. Son enregistrement publie la version et actualise tous les clients.",
      fieldAppChangelogNotes: "Notes de version",
      fieldAppChangelogNotesDesc:
        "Enregistrées dans l'historique lorsque la version de l'application change. Utilisez une ligne par changement.",
      fieldAppChangelogNotesPublishDesc:
        "Ajoutez les notes avant de publier la version ci-dessus. Les deux seront enregistrées ensemble.",
      appChangelogNotesRequired:
        "Ajoutez des notes de version avant de publier une nouvelle version.",
      fieldAppChangelogNotesPlaceholder:
      ...
      fieldSimulationIssuesEnabled: "Incidents de simulation",
      incidentSettingsDescription: "Signalements, destinataires des notifications et accès au menu.",
      incidentRecipients: "Destinataires des notifications",
      incidentAdmins: "Administrateurs",
      incidentSysAdmins: "Administrateurs système",
      incidentAddRecipient: "Ajouter un destinataire",
      incidentNoAvailableUsers: "Aucun utilisateur correspondant disponible",
      incidentNoSelectedUsers: "Aucun destinataire sélectionné.",
      incidentRecipientsHelp: "Les administrateurs sélectionnés reçoivent les notifications. Les administrateurs système sélectionnés reçoivent les escalades. Seuls les utilisateurs sélectionnés accèdent aux incidents. Les auteurs continuent de recevoir les mises à jour de leurs incidents.",
      incidentRecipientsEmpty: "Aucun administrateur sélectionné. Le menu des incidents sera masqué pour tous.",
      incidentSettingsSaved: "Configuration des incidents enregistrée.",
      incidentSettingsError: "Impossible de charger ou enregistrer la configuration. Veuillez réessayer.",
      fieldSimulationIssuesEnabledDesc:
        "Permet aux utilisateurs de signaler des incidents depuis les simulations.",
      fieldElectricityPersonalizedFixedEnabled:
        "Offre fixe personnalisée d’électricité",
      fieldElectricityPersonalizedFixedEnabledDesc:
        "Affiche les champs et l’offre Personalized Fixed dans les simulations d’électricité.",
      fieldAccessRequestsEnabled: "Demandes d’accès",
      fieldAccessRequestsEnabledDesc:
        "Permet de demander un accès depuis la page de connexion.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmails: "E-mails de demande d’accès",
      titleAccessRequestEmailsDesc:
        "Choisissez les modèles envoyés au KAM et au demandeur lors d’une nouvelle demande.",
      fieldAccessRequestKamTemplate: "Modèle de notification au KAM",
      fieldAccessRequestKamTemplateDesc:
        "Modèle envoyé au KAM sélectionné pour examen.",
      fieldAccessRequestApplicantTemplate:
        "Modèle de confirmation au demandeur",
      fieldAccessRequestApplicantTemplateDesc:
        "Modèle confirmant que la demande est en attente d’examen.",
    ...
    emailTemplatesModule: {
      ...
      typeAccessRequestKam: "Demande d’accès · KAM",
      typeAccessRequestApplicant: "Demande d’accès · Demandeur",
    ...
    rolePermissionsModule: {
      ...
      perm_label_section_simulation_issues: "Incidents de simulation",
      ...
      perm_label_simulations_download_excel:
        "Télécharger l’Excel de simulation",
      ...
      perm_desc_section_simulation_issues:
        "Consulter les incidents de simulation signalés par les agents (administrateur uniquement)",
      ...
      perm_desc_simulations_download_excel:
        "Télécharger les classeurs Excel d’origine ou remplis avec la simulation (administrateur uniquement)",
      perm_desc_simulations_delete:
  ...
  pt: {
    ...
    simulationDetail: {
      metaCups: "CUPS",
      title: "Simulação",
      shareLinkCopied: "Ligação copiada para a área de transferência",
      shareLinkCopyFailed: "Não foi possível copiar a ligação",
      openInvoiceFailed: "Não foi possível abrir a fatura",
      loading: "Carregando simulação…",
      notFound: "Simulação não encontrada.",
      metaStatus: "Status",
      metaReference: "Ref.",
      metaClient: "Cliente",
      metaClonedFrom: "Duplicada de",
      metaExpires: "Expira",
      metaCreated: "Criado",
      invoiceFile: "Fatura",
    ...
    simulationIssues: {
      ...
      snapshotNotice:
        "Uma cópia Excel imutável com os dados atuais da simulação será anexada automaticamente.",
      description: "Descrição do problema",
      descriptionRequired: "Descreva o problema antes de enviar o incidente.",
      attachFiles: "Anexar ficheiros",
      maxFileSize: "Tamanho máximo por ficheiro: {size} MB",
      remove: "Remover",
      cancel: "Cancelar",
      submit: "Enviar incidente",
      submitting: "A enviar…",
      submitSuccess: "Incidente enviado com sucesso",
      submitError: "Não foi possível enviar o incidente.",
      inbox: "Caixa de incidentes",
      status: "Estado",
      all: "Todos",
      statusNew: "Novo",
      statusInReview: "Em curso",
      statusEscalated: "Escalado para administradores da aplicação",
      emailCreated: "Novo incidente",
      notificationEscalatedTitle: "Incidente escalado para os administradores do sistema",
      emailEscalated: "Incidente escalado",
      emailStatus: "Alteração de estado",
      emailResolved: "Incidente finalizado",
      emailSettings: "Emails de incidentes",
      emailSettingsHelp: "Escolha um modelo por evento. Sem modelo, esse email fica desativado; as notificações na aplicação mantêm-se ativas. Edite os modelos em Modelos de email.",
      incidentNumber: "Número do incidente",
      exportIncidents: "Exportar incidentes",
      importIncidents: "Importar incidentes",
      transferHelp: "A exportação inclui as linhas selecionadas (até 100 incidentes / 100 MB). A importação preserva ficheiros e histórico, ignora incidentes existentes e não envia notificações.",
      importSummary: "{count} incidentes para importar; {skipped} já existem e serão ignorados.",
      importComplete: "{imported} incidentes importados; {skipped} existentes ignorados.",
      missingImportUsers: "Estes utilizadores não existem. As ligações obrigatórias usarão o sys admin que importa; as identidades originais ficam no histórico.",
      missingImportSimulations: "Estas simulações não existem. Os incidentes mantêm a referência e a captura sem ligação à simulação.",
      appAdministrators: "Administradores da aplicação",
      appStatus: "Estado dos administradores da aplicação",
      escalationNotesRequired: "Motivo do escalamento (obrigatório)",
      escalationNotesHelp: "Descreva por que este incidente precisa de suporte técnico. Os administradores do sistema serão notificados.",
      statusResolved: "Resolvido",
      statusDismissed: "Descartado",
      reporterSearch: "Nome ou e-mail do relator",
      from: "De",
      to: "Até",
      loadError: "Não foi possível carregar os incidentes",
      empty: "Nenhum incidente corresponde a estes filtros.",
      deletedSimulation: "Simulação eliminada",
      simulationExcel: "Excel da simulação",
      changeStatus: "Alterar estado",
      lastChangedBy: "Última alteração por {name}",
    },
    simulationView: {
      fieldCups: "CUPS",
    ...
    invoiceExtractor: {
      ...
      flowDescription:
        "Carregue uma fatura, confirme o provedor, extraia os campos e valide antes de criar a simulação.",
    ...
    requestAccess: {
      ...
      subtitle:
        "Envie um pedido de acesso para análise pelo gestor AXPO selecionado.",
      fullName: "Nome completo",
      email: "E-mail profissional",
      phone: "Telefone",
      agency: "Agência",
      agencyPlaceholder: "Selecione a sua agência",
      kam: "Gestor AXPO (KAM)",
      kamPlaceholder: "Selecione o seu gestor",
      kamSelectAgency: "Selecione primeiro uma agência",
      comments: "Informação adicional",
      commentsPlaceholder:
        "Adicione informação que possa ajudar na análise do pedido",
      reviewNotice:
        "O envio deste formulário solicita acesso; não cria uma conta automaticamente.",
      submit: "Enviar pedido",
      submitting: "A enviar pedido…",
      submitFailed: "Não foi possível enviar o pedido. Tente novamente.",
      successTitle: "Pedido recebido",
      successMessage:
        "O seu pedido está pendente de análise. O gestor AXPO selecionado foi notificado.",
      backToLogin: "Voltar ao login",
      optionsFailed:
        "Não foi possível carregar as agências e os gestores. Tente novamente.",
    },
    accessRequests: {
      title: "Pedidos de acesso",
      subtitle: "Analise e gira os pedidos de acesso ao simulador.",
      openPage: "Pedidos de acesso",
      applicant: "Requerente",
      requestedAt: "Pedido",
      searchPlaceholder: "Pesquisar por nome, e-mail, telefone ou agência…",
      allStatuses: "Todos os estados",
      pending: "Pendente",
      approved: "Aprovado",
      rejected: "Rejeitado",
      empty: "Nenhum pedido de acesso.",
      approve: "Aprovar",
      reject: "Rejeitar",
      approveTitle: "Aprovar pedido",
      rejectTitle: "Rejeitar pedido",
      approveConfirm: "Aprovar {name} e criar uma conta comercial?",
      rejectConfirm: "Rejeitar o pedido de {name}?",
      approvedSuccess: "Pedido aprovado e utilizador criado.",
      rejectedSuccess: "Pedido rejeitado.",
      loadError: "Não foi possível carregar os pedidos.",
      actionError: "Não foi possível atualizar o pedido.",
      comments: "Comentários",
      kamEmailStatus: "Notificação ao KAM",
      applicantEmailStatus: "Confirmação ao requerente",
      sent: "Enviada",
      notSent: "Não enviada",
      reviewedAt: "Analisado",
      assignment: "Agência / KAM",
      review: "Análise",
      contact: "Contacto",
      emailDelivery: "Envio de e-mails",
      viewPending: "Pedidos pendentes",
      viewAll: "Todos os pedidos",
      viewApproved: "Pedidos aprovados",
      viewRejected: "Pedidos rejeitados",
    },
    forgotPassword: {
    ...
    actions: {
      ...
      newBaseValueSet: "Novo conjunto de valores base",
      viewSystemLogs: "Ver registros do sistema",
    ...
    search: {
      ...
      globalPlaceholder:
        "Pesquisar simulações, clientes, usuários, agências...",
      globalMinChars:
        "Digite pelo menos {min} caracteres para pesquisar registros.",
      globalSearching: "Pesquisando...",
      globalEmpty: "Nenhum registro encontrado.",
      globalEmptyRecents:
        "Registros e páginas abertos recentemente aparecerão aqui.",
      kindSimulation: "Simulação",
      kindUser: "Usuário",
      kindAgency: "Agência",
      kindAgencyTlv: "Agência TLV",
      kindClient: "Cliente",
      kindRecent: "Recente",
    },
    pagination: {
    ...
    simulationsModule: {
      ...
      cupsValidationFailed: "A validação do CUPS falhou.",
      invalidExpirationDays:
        "Os dias de validade devem ser um número positivo.",
      createdAsDraft: "Simulação criada como rascunho.",
      invalidPayloadJson:
        "O JSON dos dados é inválido; verifique as alterações.",
      updated: "Simulação atualizada.",
      sharedWithToken: "Partilhada. Token: {token}",
      shared: "Simulação partilhada.",
      cloned: "Simulação clonada.",
      pinRefreshed: "Instantâneo do PIN atualizado.",
      ocrPrefillCreated: "Versão de pré-preenchimento OCR criada.",
      pdfDownloaded: "PDF transferido.",
      archived: "Simulação arquivada.",
      bulkDeletedResult: "Eliminadas {succeeded} de {total} simulações.",
      bulkArchivedResult: "Arquivadas {succeeded} de {total} simulações.",
      calculationCompleted: "Cálculo concluído — {count} produtos avaliados.",
      ...
      statusShared: "Partilhada",
      clientViewed: "Visualizado",
      sharedViaEmail: "por e-mail",
      sharedViaPdf: "Via PDF",
      viewPresetLabel: "Vista",
      customView: "Vista personalizada",
      savedViewsGroup: "Vistas salvas",
      deleteSavedView: "Excluir vista salva",
      presetRecent: "Recentes",
      presetMyDrafts: "Meus rascunhos",
      presetSharedWithMe: "Compartilhadas comigo",
      presetExpiringSoon: "Expiram em breve",
      presetArchived: "Arquivadas",
      filtersTitle: "Filtros",
      saveView: "Salvar vista",
      ownerFilter: "Proprietário",
      clientFilter: "Cliente",
      statusFilter: "Status",
      typeFilter: "Tipo",
      allTypes: "Todos os tipos",
      typeElectricity: "Eletricidade",
      typeGas: "Gás",
      typeBoth: "Ambos",
      cupsFilter: "CUPS",
      ...
      expiresFrom: "Expira desde",
      expiresTo: "Expira até",
      sortBy: "Ordenar por",
      sortDirection: "Direção",
      sortUpdated: "Atualizada",
      sortCreated: "Criada",
      sortExpires: "Expira",
      sortReference: "Referência",
      sortStatus: "Status",
      directionDescending: "Descendente",
      directionAscending: "Ascendente",
      clearFilters: "Limpar filtros",
      applyFilters: "Aplicar filtros",
      saveViewTitle: "Salvar vista",
      saveViewDescription:
        "Salva a configuração atual da vista, filtros avançados, ordenação e modo arquivado.",
    ...
    usersModule: {
      ...
      createRequiredFields:
        "O nome, email, telemóvel, contacto comercial e agência são obrigatórios.",
      updateRequiredFields:
        "O nome completo, email, telemóvel e contactos comerciais são obrigatórios.",
      passwordPolicy:
        "A palavra-passe deve ter entre 12 e 128 caracteres, com maiúscula, minúscula, número e caráter especial.",
      newPasswordPolicy:
        "A nova palavra-passe deve cumprir a política de segurança.",
      agentCreateRestriction:
        "O agente só pode criar utilizadores comerciais na mesma agência.",
      currentPasswordRequired:
        "A palavra-passe atual é obrigatória para alterar a sua própria palavra-passe.",
      created: "Utilizador criado.",
      createdWithPin: "Utilizador criado. PIN temporário: {pin}",
      updated: "Utilizador atualizado.",
      userAndPasswordUpdated: "Utilizador e palavra-passe atualizados.",
      profileRequiredFields: "O nome completo e o email são obrigatórios.",
      profileUpdated: "Perfil atualizado.",
      statusUpdated: "Estado do utilizador atualizado.",
      pinRotated: "PIN renovado: {pin}",
      deleted: "Utilizador eliminado.",
      bulkDeleted: "{count} utilizador(es) eliminado(s).",
      passwordResetSent: "Email de reposição enviado para {email}",
    ...
    agenciesModule: {
      ...
      activated: "Agência ativada.",
      deactivated: "Agência desativada.",
      deleted: "Agência eliminada.",
    ...
    clientsModule: {
      ...
      deactivated: "Cliente desativado.",
      deleted: "Cliente eliminado.",
      bulkDeleted: "{count} cliente(s) eliminado(s).",
    ...
    logs: {
      ...
      simulationIssues: "Incidentes de simulação",
      timestamp: "Carimbo de data e hora",
      type: "Tipo",
      status: "Status",
      message: "Mensagem",
      ...
      unexpectedErrors: "Erros inesperados",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreating: "Agências criadoras",
      kpiAgenciesCreatingSub: "Seus usuários criaram simulações neste período",
      ...
      kpiSharedBreakdown: "{email} por e-mail · {pdf} por PDF",
      sharePercentOfShared: "dos compartilhamentos",
      funnelPercentOfCreated: "das criadas",
      funnelPercentOfEmailed: "das enviadas por e-mail",
      funnelOpenedWeb: "Abertas na web",
      kpiSimsShared: "Simulações compartilhadas",
      kpiShareMethods: "Métodos de compartilhamento",
      kpiShareMethodsSub: "{pdf}% PDF · {email}% e-mail",
      kpiUsersCreating: "Criadores de simulações",
      kpiUsersCreatingSub: "Criaram simulações neste período",
      kpiEmailSentSub: "{opened} de {sent} e-mails abertos",
      kpiOpenRate: "Taxa de abertura",
      kpiOpenRateSub: "{count} total de aberturas",
      kpiTotalOpens: "Total de aberturas",
      kpiTotalOpensSub: "Em {count} e-mails abertos",
      ...
      vsPreviousPeriod: "vs. os {days} dias anteriores",
      previousPeriodValue: "Período anterior",
    ...
    baseValuesModule: {
      ...
      activated: "Conjunto de valores base ativado.",
      archived: "Conjunto de valores base arquivado.",
      restored: "Conjunto de valores base restaurado.",
      bulkArchived: "{count} conjunto(s) de valores base arquivado(s).",
      productionSet:
        "Conjunto definido como produção {scope}. Os outros conjuntos {scope} foram marcados como rascunho.",
      newSet: "Novo conjunto de valores base",
      editSet_tooltip: "Editar conjunto de valores base",
      download_tooltip: "Baixe o arquivo fonte Excel",
      downloadExcel: "Baixar Excel",
      downloadOriginalExcel: "Baixar Excel original",
      downloadFilledSimulationExcel:
        "Baixar Excel com dados da simulação (Beta)",
    ...
    whatsNewModal: {
      ...
      empty: "Ainda não foram publicadas notas de versão.",
      emptyVersion: "Não foram publicadas notas para esta versão.",
      goToChangelog: "Ir para o registo de alterações",
    },
    auth: {
      login: "Login",
      logout: "Sair",
    ...
    agencyTlvProducts: {
      title: "Produtos",
      description:
        "Configure quais produtos ativos esta agência pode oferecer.",
      loading: "Carregando configuração de produtos...",
      loadError: "Falha ao carregar a configuração de produtos",
      saveError: "Falha ao salvar a configuração de produtos",
      saveSuccess: "Configuração de produtos salva.",
      electricity: "Eletricidade",
      gas: "Gás",
      fixed: "Corrigido",
      indexed: "Indexado",
    ...
    systemSettings: {
      ...
      fieldAppVersionDesc:
        "Defina a nova versão antes da implantação. Ao guardar, a versão é publicada e todos os clientes são atualizados.",
      fieldAppChangelogNotes: "Notas da versão",
      fieldAppChangelogNotesDesc:
        "Guardadas no histórico quando a versão da aplicação muda. Usa uma linha por alteração.",
      fieldAppChangelogNotesPublishDesc:
        "Adicione as notas antes de publicar a versão indicada acima. Ambas serão guardadas em conjunto.",
      appChangelogNotesRequired:
        "Adicione notas da versão antes de publicar uma nova versão.",
      fieldAppChangelogNotesPlaceholder:
        "Filtros do painel melhorados\nValidação de faturas adicionada\nTotais de exportação PDF corrigidos",
      appChangelogHistory: "Histórico de versões",
      appChangelogEmpty: "Ainda não há histórico de versões.",
      ...
      fieldSimulationIssuesEnabled: "Incidentes de simulação",
      incidentSettingsDescription: "Relatos, destinatários de notificações e acesso ao menu.",
      incidentRecipients: "Destinatários de notificações",
      incidentAdmins: "Administradores",
      incidentSysAdmins: "Administradores de sistema",
      incidentAddRecipient: "Adicionar destinatário",
      incidentNoAvailableUsers: "Nenhum utilizador correspondente disponível",
      incidentNoSelectedUsers: "Nenhum destinatário selecionado.",
      incidentRecipientsHelp: "Os administradores selecionados recebem notificações de incidentes. Os administradores de sistema selecionados recebem escalamentos. Apenas os utilizadores selecionados podem aceder aos incidentes. Os autores continuam a receber atualizações dos seus próprios incidentes.",
      incidentRecipientsEmpty: "Nenhum administrador selecionado. O menu de incidentes ficará oculto para todos.",
      incidentSettingsSaved: "Configuração de incidentes guardada.",
      incidentSettingsError: "Não foi possível carregar ou guardar a configuração. Tente novamente.",
      fieldSimulationIssuesEnabledDesc:
        "Permite aos utilizadores reportar incidentes nas simulações.",
      fieldElectricityPersonalizedFixedEnabled:
        "Oferta fixa personalizada de eletricidade",
      fieldElectricityPersonalizedFixedEnabledDesc:
        "Mostra os campos e a oferta Personalized Fixed nas simulações de eletricidade.",
      fieldAccessRequestsEnabled: "Pedidos de acesso",
      fieldAccessRequestsEnabledDesc:
        "Permite pedir acesso a partir da página de início de sessão.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmails: "E-mails de pedido de acesso",
      titleAccessRequestEmailsDesc:
        "Escolha os modelos enviados ao KAM e ao requerente quando é submetido um pedido.",
      fieldAccessRequestKamTemplate: "Modelo de notificação ao KAM",
      fieldAccessRequestKamTemplateDesc:
        "Modelo enviado ao KAM selecionado para análise.",
      fieldAccessRequestApplicantTemplate:
        "Modelo de confirmação ao requerente",
      fieldAccessRequestApplicantTemplateDesc:
        "Modelo que confirma que o pedido está pendente de análise.",
    ...
    emailTemplatesModule: {
      ...
      typeAccessRequestKam: "Pedido de acesso · KAM",
      typeAccessRequestApplicant: "Pedido de acesso · Requerente",
    ...
    rolePermissionsModule: {
      ...
      perm_label_section_simulation_issues: "Incidentes de simulação",
      ...
      perm_label_simulations_download_excel: "Baixar Excel da simulação",
      ...
      perm_desc_section_simulation_issues:
        "Rever incidentes de simulação reportados pelos agentes (somente administrador)",
      ...
      perm_desc_simulations_download_excel:
        "Baixar arquivos Excel originais ou preenchidos com a simulação (somente administrador)",
      perm_desc_simulations_delete:
