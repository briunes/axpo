export const translations = {
  en: {
    ...
    userFormPage: {
      ...
      pinCallout:
        "User created — save this PIN now, it will not be shown again",
      userLabel: "User",
      pinLabel: "PIN",
      createdWithPin:
        "User created successfully. Save the PIN below—it won't be shown again.",
  ...
  es: {
    ...
    userFormPage: {
      ...
      pinCallout:
        "Usuario creado — guarda este PIN ahora, no se mostrará de nuevo",
      userLabel: "Usuario",
      pinLabel: "PIN",
      createdWithPin:
        "Usuario creado correctamente. Guarda el PIN a continuación—no se mostrará de nuevo.",
