export const translations = {
  en: {
    ...
    requestAccess: {
      ...
      subtitle: "Send an access request for review by the selected AXPO account manager.",
      fullName: "Full name",
      ...
      commentsPlaceholder: "Add any information that may help us review your request",
      reviewNotice: "Submitting this form requests access; it does not create an account automatically.",
      submit: "Submit request",
      submitting: "Submitting request…",
      submitFailed: "We could not submit your request. Please try again.",
      successTitle: "Request received",
      successMessage: "Your request is pending review. The selected AXPO account manager has been notified.",
      backToLogin: "Back to login",
      optionsFailed: "We could not load agencies and account managers. Please try again.",
    },
    accessRequests: {
      title: "Access requests", subtitle: "Review and manage requests for simulator access.", openPage: "Access requests",
      applicant: "Applicant", requestedAt: "Requested", searchPlaceholder: "Search by name, email, phone or agency…",
      allStatuses: "All statuses", pending: "Pending", approved: "Approved", rejected: "Rejected", empty: "No access requests found.",
      approve: "Approve", reject: "Reject", approveTitle: "Approve access request", rejectTitle: "Reject access request",
      approveConfirm: "Approve {name} and create a commercial user account?", rejectConfirm: "Reject the access request from {name}?",
      approvedSuccess: "Request approved and user created.", rejectedSuccess: "Request rejected.", loadError: "Could not load access requests.", actionError: "Could not update the access request.",
      comments: "Comments", kamEmailStatus: "KAM notification", applicantEmailStatus: "Applicant confirmation", sent: "Sent", notSent: "Not sent", reviewedAt: "Reviewed",
      assignment: "Agency / KAM", review: "Review", contact: "Contact", emailDelivery: "Email delivery",
      viewPending: "Pending requests", viewAll: "All requests", viewApproved: "Approved requests", viewRejected: "Rejected requests",
    },
    forgotPassword: {
    ...
    simulationIssues: {
      report: "Report issue", reportTooltip: "Report a problem with this simulation", title: "Report issue",
      snapshotNotice: "An immutable Excel copy containing the simulation's current data will be attached automatically.",
      description: "Issue description", descriptionRequired: "Describe the problem before submitting the issue.",
      attachFiles: "Attach files", maxFileSize: "Maximum size per file: {size} MB", remove: "Remove",
      cancel: "Cancel", submit: "Submit issue", submitting: "Submitting…", submitSuccess: "Issue submitted successfully",
      submitError: "The issue could not be submitted.", inbox: "Issue inbox", status: "Status", all: "All",
      statusNew: "New", statusInReview: "In review", statusResolved: "Resolved", statusDismissed: "Dismissed",
      reporterSearch: "Reporter name or email", from: "From", to: "To", loadError: "Issues could not be loaded",
      empty: "No issues match these filters.", deletedSimulation: "Deleted simulation", simulationExcel: "Simulation Excel",
      changeStatus: "Change status", lastChangedBy: "Last changed by {name}",
    },
    simulationView: {
    ...
    systemSettings: {
      ...
      fieldSimulationIssuesEnabledDesc: "Allow users to report incidents from simulations.",
      fieldElectricityPersonalizedFixedEnabled: "Electricity personalized fixed offer",
      fieldElectricityPersonalizedFixedEnabledDesc: "Show the Personalized Fixed inputs and offer in electricity simulations.",
      fieldAccessRequestsEnabled: "Access requests",
      fieldAccessRequestsEnabledDesc: "Allow prospective users to submit access requests from the login page.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmailsDesc: "Choose the templates sent to the selected KAM and applicant when a request is submitted.",
      fieldAccessRequestKamTemplate: "KAM Notification Template",
      fieldAccessRequestKamTemplateDesc: "Template sent to the selected KAM for review.",
      fieldAccessRequestApplicantTemplate: "Applicant Confirmation Template",
      fieldAccessRequestApplicantTemplateDesc: "Template confirming that the request is pending review.",
  ...
  es: {
    ...
    requestAccess: {
      ...
      subtitle: "Envía una solicitud de acceso para que la revise el KAM de AXPO seleccionado.",
      ...
      commentsPlaceholder: "Añade cualquier información que nos ayude a revisar tu solicitud",
      reviewNotice: "El envío de este formulario solicita el acceso; no crea una cuenta automáticamente.",
      submit: "Enviar solicitud",
      submitting: "Enviando solicitud…",
      submitFailed: "No se pudo enviar la solicitud. Inténtalo de nuevo.",
      successTitle: "Solicitud recibida",
      successMessage: "Tu solicitud está pendiente de revisión. Se ha notificado al KAM de AXPO seleccionado.",
      backToLogin: "Volver al inicio de sesión",
      optionsFailed: "No se pudieron cargar las agencias y los KAM. Inténtalo de nuevo.",
    },
    accessRequests: {
      title: "Solicitudes de alta", subtitle: "Revisa y gestiona las solicitudes de acceso al simulador.", openPage: "Solicitudes de alta",
      applicant: "Solicitante", requestedAt: "Solicitada", searchPlaceholder: "Buscar por nombre, correo, teléfono o agencia…",
      allStatuses: "Todos los estados", pending: "Pendiente", approved: "Aprobada", rejected: "Rechazada", empty: "No hay solicitudes de alta.",
      approve: "Aprobar", reject: "Rechazar", approveTitle: "Aprobar solicitud", rejectTitle: "Rechazar solicitud",
      approveConfirm: "¿Aprobar a {name} y crear una cuenta de usuario comercial?", rejectConfirm: "¿Rechazar la solicitud de {name}?",
      approvedSuccess: "Solicitud aprobada y usuario creado.", rejectedSuccess: "Solicitud rechazada.", loadError: "No se pudieron cargar las solicitudes.", actionError: "No se pudo actualizar la solicitud.",
      comments: "Comentarios", kamEmailStatus: "Notificación al KAM", applicantEmailStatus: "Confirmación al solicitante", sent: "Enviado", notSent: "No enviado", reviewedAt: "Revisada",
      assignment: "Agencia / KAM", review: "Revisión", contact: "Contacto", emailDelivery: "Envío de correos",
      viewPending: "Solicitudes pendientes", viewAll: "Todas las solicitudes", viewApproved: "Solicitudes aprobadas", viewRejected: "Solicitudes rechazadas",
    },
    forgotPassword: {
    ...
    search: {
      ...
      globalMinChars: "Escribe al menos {min} caracteres para buscar registros.",
      globalSearching: "Buscando...",
      globalEmpty: "No se encontraron registros.",
      globalEmptyRecents: "Los registros y páginas abiertos recientemente aparecerán aquí.",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreatingSub: "Sus usuarios crearon simulaciones en este período",
    ...
    baseValuesModule: {
      ...
      downloadFilledSimulationExcel: "Descargar Excel con datos de la simulación (Beta)",
    ...
    simulationIssues: {
      report: "Reportar incidencia", reportTooltip: "Reportar un problema con esta simulación", title: "Reportar incidencia",
      snapshotNotice: "Se adjuntará automáticamente una copia inalterable del Excel con los datos actuales de la simulación.",
      description: "Descripción del problema", descriptionRequired: "Describe el problema antes de enviar la incidencia.",
      attachFiles: "Adjuntar archivos", maxFileSize: "Tamaño máximo por archivo: {size} MB", remove: "Quitar",
      cancel: "Cancelar", submit: "Enviar incidencia", submitting: "Enviando…", submitSuccess: "Incidencia enviada correctamente",
      submitError: "No se pudo enviar la incidencia.", inbox: "Buzón de incidencias", status: "Estado", all: "Todos",
      statusNew: "Nueva", statusInReview: "En revisión", statusResolved: "Resuelta", statusDismissed: "Descartada",
      reporterSearch: "Nombre o email del informador", from: "Desde", to: "Hasta", loadError: "No se pudieron cargar las incidencias",
      empty: "No hay incidencias con estos filtros.", deletedSimulation: "Simulación eliminada", simulationExcel: "Excel de la simulación",
      changeStatus: "Cambiar estado", lastChangedBy: "Último cambio por {name}",
    },
    simulationView: {
    ...
    systemSettings: {
      ...
      fieldSimulationIssuesEnabledDesc: "Permite a los usuarios reportar incidencias desde las simulaciones.",
      fieldElectricityPersonalizedFixedEnabled: "Oferta fija personalizada de electricidad",
      fieldElectricityPersonalizedFixedEnabledDesc: "Muestra los campos y la oferta Personalizada Fixed en las simulaciones de electricidad.",
      fieldAccessRequestsEnabled: "Solicitudes de acceso",
      fieldAccessRequestsEnabledDesc: "Permite solicitar acceso desde la página de inicio de sesión.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmailsDesc: "Selecciona las plantillas enviadas al KAM y al solicitante al recibir una solicitud.",
      fieldAccessRequestKamTemplate: "Plantilla de Notificación al KAM",
      fieldAccessRequestKamTemplateDesc: "Plantilla enviada al KAM seleccionado para su revisión.",
      fieldAccessRequestApplicantTemplate: "Plantilla de Confirmación al Solicitante",
      fieldAccessRequestApplicantTemplateDesc: "Plantilla que confirma que la solicitud está pendiente de revisión.",
  ...
  fr: {
    ...
    simulationIssues: {
      report: "Signaler un incident", reportTooltip: "Signaler un problème avec cette simulation", title: "Signaler un incident",
      snapshotNotice: "Une copie Excel non modifiable contenant les données actuelles de la simulation sera jointe automatiquement.",
      description: "Description du problème", descriptionRequired: "Décrivez le problème avant d'envoyer l'incident.",
      attachFiles: "Joindre des fichiers", maxFileSize: "Taille maximale par fichier : {size} MB", remove: "Retirer",
      cancel: "Annuler", submit: "Envoyer l'incident", submitting: "Envoi…", submitSuccess: "Incident envoyé avec succès",
      submitError: "L'incident n'a pas pu être envoyé.", inbox: "Boîte des incidents", status: "Statut", all: "Tous",
      statusNew: "Nouveau", statusInReview: "En cours d'examen", statusResolved: "Résolu", statusDismissed: "Rejeté",
      reporterSearch: "Nom ou e-mail du déclarant", from: "Du", to: "Au", loadError: "Impossible de charger les incidents",
      empty: "Aucun incident ne correspond à ces filtres.", deletedSimulation: "Simulation supprimée", simulationExcel: "Excel de la simulation",
      changeStatus: "Modifier le statut", lastChangedBy: "Dernière modification par {name}",
    },
    simulationView: {
      fieldCups: "CUPS",
    ...
    requestAccess: {
      ...
      subtitle: "Envoyez une demande d'accès qui sera examinée par le responsable AXPO sélectionné.",
      ...
      commentsPlaceholder: "Ajoutez toute information utile à l'examen de votre demande",
      reviewNotice: "L'envoi de ce formulaire demande un accès ; il ne crée pas automatiquement un compte.",
      submit: "Envoyer la demande",
      submitting: "Envoi de la demande…",
      submitFailed: "Impossible d'envoyer votre demande. Veuillez réessayer.",
      successTitle: "Demande reçue",
      successMessage: "Votre demande est en attente d'examen. Le responsable AXPO sélectionné a été informé.",
      backToLogin: "Retour à la connexion",
      optionsFailed: "Impossible de charger les agences et responsables. Veuillez réessayer.",
    },
    accessRequests: {
      title: "Demandes d’accès", subtitle: "Examinez et gérez les demandes d’accès au simulateur.", openPage: "Demandes d’accès",
      applicant: "Demandeur", requestedAt: "Demandée", searchPlaceholder: "Rechercher par nom, e-mail, téléphone ou agence…",
      allStatuses: "Tous les statuts", pending: "En attente", approved: "Approuvée", rejected: "Rejetée", empty: "Aucune demande d’accès.",
      approve: "Approuver", reject: "Rejeter", approveTitle: "Approuver la demande", rejectTitle: "Rejeter la demande",
      approveConfirm: "Approuver {name} et créer un compte commercial ?", rejectConfirm: "Rejeter la demande de {name} ?",
      approvedSuccess: "Demande approuvée et utilisateur créé.", rejectedSuccess: "Demande rejetée.", loadError: "Impossible de charger les demandes.", actionError: "Impossible de mettre à jour la demande.",
      comments: "Commentaires", kamEmailStatus: "Notification au KAM", applicantEmailStatus: "Confirmation au demandeur", sent: "Envoyée", notSent: "Non envoyée", reviewedAt: "Examinée",
      assignment: "Agence / KAM", review: "Examen", contact: "Contact", emailDelivery: "Envoi des e-mails",
      viewPending: "Demandes en attente", viewAll: "Toutes les demandes", viewApproved: "Demandes approuvées", viewRejected: "Demandes rejetées",
    },
    forgotPassword: {
    ...
    search: {
      ...
      globalPlaceholder: "Rechercher des simulations, clients, utilisateurs, agences...",
      globalMinChars: "Saisissez au moins {min} caractères pour rechercher des enregistrements.",
      globalSearching: "Recherche en cours...",
      globalEmpty: "Aucun enregistrement trouvé.",
      globalEmptyRecents: "Les enregistrements et pages ouverts récemment apparaîtront ici.",
      kindSimulation: "Simulation",
    ...
    analyticsModule: {
      ...
      kpiAgenciesCreatingSub: "Leurs utilisateurs ont créé des simulations sur cette période",
    ...
    baseValuesModule: {
      ...
      downloadFilledSimulationExcel: "Télécharger Excel avec les données de la simulation (Beta)",
    ...
    whatsNewModal: {
      ...
      emptyVersion: "Aucune note de version n'a été publiée pour cette version.",
    ...
    systemSettings: {
      ...
      fieldSimulationIssuesEnabledDesc: "Permet aux utilisateurs de signaler des incidents depuis les simulations.",
      fieldElectricityPersonalizedFixedEnabled: "Offre fixe personnalisée d’électricité",
      fieldElectricityPersonalizedFixedEnabledDesc: "Affiche les champs et l’offre Personalized Fixed dans les simulations d’électricité.",
      fieldAccessRequestsEnabled: "Demandes d’accès",
      fieldAccessRequestsEnabledDesc: "Permet de demander un accès depuis la page de connexion.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmailsDesc: "Choisissez les modèles envoyés au KAM et au demandeur lors d’une nouvelle demande.",
      fieldAccessRequestKamTemplate: "Modèle de notification au KAM",
      fieldAccessRequestKamTemplateDesc: "Modèle envoyé au KAM sélectionné pour examen.",
      fieldAccessRequestApplicantTemplate: "Modèle de confirmation au demandeur",
      fieldAccessRequestApplicantTemplateDesc: "Modèle confirmant que la demande est en attente d’examen.",
    ...
    rolePermissionsModule: {
      ...
      perm_label_simulations_download_excel: "Télécharger l’Excel de simulation",
  ...
  pt: {
    ...
    simulationIssues: {
      report: "Reportar incidente", reportTooltip: "Reportar um problema com esta simulação", title: "Reportar incidente",
      snapshotNotice: "Uma cópia Excel imutável com os dados atuais da simulação será anexada automaticamente.",
      description: "Descrição do problema", descriptionRequired: "Descreva o problema antes de enviar o incidente.",
      attachFiles: "Anexar ficheiros", maxFileSize: "Tamanho máximo por ficheiro: {size} MB", remove: "Remover",
      cancel: "Cancelar", submit: "Enviar incidente", submitting: "A enviar…", submitSuccess: "Incidente enviado com sucesso",
      submitError: "Não foi possível enviar o incidente.", inbox: "Caixa de incidentes", status: "Estado", all: "Todos",
      statusNew: "Novo", statusInReview: "Em análise", statusResolved: "Resolvido", statusDismissed: "Descartado",
      reporterSearch: "Nome ou e-mail do relator", from: "De", to: "Até", loadError: "Não foi possível carregar os incidentes",
      empty: "Nenhum incidente corresponde a estes filtros.", deletedSimulation: "Simulação eliminada", simulationExcel: "Excel da simulação",
      changeStatus: "Alterar estado", lastChangedBy: "Última alteração por {name}",
    },
    simulationView: {
      fieldCups: "CUPS",
    ...
    requestAccess: {
      ...
      subtitle: "Envie um pedido de acesso para análise pelo gestor AXPO selecionado.",
      ...
      commentsPlaceholder: "Adicione informação que possa ajudar na análise do pedido",
      reviewNotice: "O envio deste formulário solicita acesso; não cria uma conta automaticamente.",
      submit: "Enviar pedido",
      submitting: "A enviar pedido…",
      submitFailed: "Não foi possível enviar o pedido. Tente novamente.",
      successTitle: "Pedido recebido",
      successMessage: "O seu pedido está pendente de análise. O gestor AXPO selecionado foi notificado.",
      backToLogin: "Voltar ao login",
      optionsFailed: "Não foi possível carregar as agências e os gestores. Tente novamente.",
    },
    accessRequests: {
      title: "Pedidos de acesso", subtitle: "Analise e gira os pedidos de acesso ao simulador.", openPage: "Pedidos de acesso",
      applicant: "Requerente", requestedAt: "Pedido", searchPlaceholder: "Pesquisar por nome, e-mail, telefone ou agência…",
      allStatuses: "Todos os estados", pending: "Pendente", approved: "Aprovado", rejected: "Rejeitado", empty: "Nenhum pedido de acesso.",
      approve: "Aprovar", reject: "Rejeitar", approveTitle: "Aprovar pedido", rejectTitle: "Rejeitar pedido",
      approveConfirm: "Aprovar {name} e criar uma conta comercial?", rejectConfirm: "Rejeitar o pedido de {name}?",
      approvedSuccess: "Pedido aprovado e utilizador criado.", rejectedSuccess: "Pedido rejeitado.", loadError: "Não foi possível carregar os pedidos.", actionError: "Não foi possível atualizar o pedido.",
      comments: "Comentários", kamEmailStatus: "Notificação ao KAM", applicantEmailStatus: "Confirmação ao requerente", sent: "Enviada", notSent: "Não enviada", reviewedAt: "Analisado",
      assignment: "Agência / KAM", review: "Análise", contact: "Contacto", emailDelivery: "Envio de e-mails",
      viewPending: "Pedidos pendentes", viewAll: "Todos os pedidos", viewApproved: "Pedidos aprovados", viewRejected: "Pedidos rejeitados",
    },
    forgotPassword: {
    ...
    search: {
      ...
      globalPlaceholder: "Pesquisar simulações, clientes, usuários, agências...",
      globalMinChars: "Digite pelo menos {min} caracteres para pesquisar registros.",
      globalSearching: "Pesquisando...",
      globalEmpty: "Nenhum registro encontrado.",
      globalEmptyRecents: "Registros e páginas abertos recentemente aparecerão aqui.",
    ...
    baseValuesModule: {
      ...
      downloadFilledSimulationExcel: "Baixar Excel com dados da simulação (Beta)",
    ...
    systemSettings: {
      ...
      fieldSimulationIssuesEnabledDesc: "Permite aos utilizadores reportar incidentes nas simulações.",
      fieldElectricityPersonalizedFixedEnabled: "Oferta fixa personalizada de eletricidade",
      fieldElectricityPersonalizedFixedEnabledDesc: "Mostra os campos e a oferta Personalized Fixed nas simulações de eletricidade.",
      fieldAccessRequestsEnabled: "Pedidos de acesso",
      fieldAccessRequestsEnabledDesc: "Permite pedir acesso a partir da página de início de sessão.",
      fieldExpirationDesc:
      ...
      titleAccessRequestEmailsDesc: "Escolha os modelos enviados ao KAM e ao requerente quando é submetido um pedido.",
      fieldAccessRequestKamTemplate: "Modelo de notificação ao KAM",
      fieldAccessRequestKamTemplateDesc: "Modelo enviado ao KAM selecionado para análise.",
      fieldAccessRequestApplicantTemplate: "Modelo de confirmação ao requerente",
      fieldAccessRequestApplicantTemplateDesc: "Modelo que confirma que o pedido está pendente de análise.",
