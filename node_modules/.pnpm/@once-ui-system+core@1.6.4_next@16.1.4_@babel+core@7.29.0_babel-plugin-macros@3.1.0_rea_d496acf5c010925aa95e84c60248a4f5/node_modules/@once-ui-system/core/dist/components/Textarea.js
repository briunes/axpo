...
const Textarea = forwardRef(({ id, label, placeholder, lines = 3, error = false, errorMessage, description, radius, className, hasPrefix, hasSuffix, characterCount, resize = "vertical", validate, children, onFocus, onBlur, onChange, style, ...props }, ref) => {
    ...
    const textareaClassNames = classNames(styles.input, styles.textarea, "font-body", "font-default", "font-m", {
    ...
    return (_jsxs(Column, { gap: "8", fillWidth: true, fitHeight: true, className: classNames(className, {
            [styles.error]: displayError && debouncedValue !== "",
        }), children: [_jsxs(Row, { minHeight: placeholder ? "48" : "56", transition: "micro-medium", border: "neutral-medium", background: "neutral-alpha-weak", overflow: "hidden", vertical: "stretch", className: classNames(styles.base, lines !== "auto" && resize !== "none" && styles.textareaBase, radius === "none" ? "radius-none" : radius ? `radius-l-${radius}` : "radius-l"), children: [hasPrefix && (_jsx(Row, { paddingLeft: "12", className: styles.prefix, children: hasPrefix })), _jsxs(Column, { fillWidth: true, children: [_jsx("textarea", { ...props, ref: (node) => {
                                ...
                                }, id: id, rows: typeof lines === "number" ? lines : 1, placeholder: placeholder, onFocus: handleFocus, onBlur: handleBlur, className: textareaClassNames + " scrollbar-minimal", "aria-describedby": displayError ? `${id}-error` : undefined, "aria-invalid": !!displayError, style: {
                                    ...style,
                                ...
                                }), children: label })), children, characterCount && props.maxLength && (_jsx(Row, { fillWidth: true, paddingLeft: "16", paddingY: "8", className: styles.suffix, children: _jsx(Text, { variant: "label-default-s", onBackground: props.maxLength - String(props.value || '').length <= 5
                                        ? "danger-weak"
