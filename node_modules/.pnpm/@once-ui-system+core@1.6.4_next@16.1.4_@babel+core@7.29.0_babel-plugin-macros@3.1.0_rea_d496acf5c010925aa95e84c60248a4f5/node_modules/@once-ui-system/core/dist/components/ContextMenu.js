...
const ContextMenu = forwardRef(({ children, dropdown, minHeight, onSelect, closeAfterClick = true, isOpen, onOpenChange, minWidth = 12, maxWidth, fillWidth = false, placement = "bottom-end", className, style, ...rest }, ref) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(ScrollLock, { enabled: isDropdownOpen, allowScrollInElement: dropdownRef }), _jsxs(Flex, { ref: containerRef, onContextMenu: handleContextMenu, onClick: handleClick, className: className || "", style: style, children: [children, isDropdownOpen &&
                        isBrowser &&
